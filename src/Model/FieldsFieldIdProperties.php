 ...
 * @link     https://openapi-generator.tech
 */
class FieldsFieldIdProperties implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['summaryQuery'] = isset($data['summaryQuery']) ? $data['summaryQuery'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['summaryFunction']) && !in_array($this->container['summaryFunction'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'summaryFunction', must be one of '%s'",
