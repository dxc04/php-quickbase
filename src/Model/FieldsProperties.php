 ...
 */
class FieldsProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMaxVersions($maxVersions)
    {
        ...
        if (!is_null($maxVersions) && ($maxVersions < 1)) {
            throw new \InvalidArgumentException('invalid value for $maxVersions when calling FieldsProperties., must be bigger than or equal to 1.');
        }
