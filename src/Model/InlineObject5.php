...
class InlineObject5 implements ModelInterface, ArrayAccess
{
     ...
     * Sets name
     *
     * @param string|null $name The name for the table.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $pluralRecordName The plural noun for records in the table. If this value is not passed the default value is 'Records'.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $singleRecordName The singular noun for records in the table. If this value is not passed the default value is 'Record'.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description The description for the table. If this value is not passed the default value is blank.
     *
     * @return $this
     */
