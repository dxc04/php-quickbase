...
class ReportsApi
{
     ...
     */
    protected function getReportRequest($reportId, $tableId, $qBRealmHostname, $authorization, $userAgent = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTableReportsRequest($tableId, $qBRealmHostname, $authorization, $userAgent = null)
    {
        // verify the required parameter 'tableId' is set
        if ($tableId === null || (is_array($tableId) && count($tableId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function runReportRequest($reportId, $tableId, $qBRealmHostname, $authorization, $skip = null, $top = null, $userAgent = null, $generated = null)
    {
        // verify the required parameter 'reportId' is set
        if ($reportId === null || (is_array($reportId) && count($reportId) === 0)) {
            throw new \InvalidArgumentException(
