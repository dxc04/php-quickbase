...
class FieldsApi
{
     ...
     */
    protected function createFieldRequest($tableId, $qBRealmHostname, $authorization, $userAgent = null, $generated = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteFieldsRequest($tableId, $qBRealmHostname, $authorization, $userAgent = null, $generated = null)
    {
        // verify the required parameter 'tableId' is set
        if ($tableId === null || (is_array($tableId) && count($tableId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFieldRequest($fieldId, $tableId, $qBRealmHostname, $authorization, $includeFieldPerms = false, $userAgent = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFieldUsageRequest($fieldId, $tableId, $qBRealmHostname, $authorization, $userAgent = null)
    {
        // verify the required parameter 'fieldId' is set
        if ($fieldId === null || (is_array($fieldId) && count($fieldId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFieldsRequest($tableId, $qBRealmHostname, $authorization, $includeFieldPerms = false, $userAgent = null)
    {
        // verify the required parameter 'tableId' is set
        if ($tableId === null || (is_array($tableId) && count($tableId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFieldsUsageRequest($tableId, $qBRealmHostname, $authorization, $skip = null, $top = null, $userAgent = null)
    {
        // verify the required parameter 'tableId' is set
        if ($tableId === null || (is_array($tableId) && count($tableId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateFieldRequest($fieldId, $tableId, $qBRealmHostname, $authorization, $userAgent = null, $generated = null)
    {
        // verify the required parameter 'fieldId' is set
        if ($fieldId === null || (is_array($fieldId) && count($fieldId) === 0)) {
            throw new \InvalidArgumentException(
