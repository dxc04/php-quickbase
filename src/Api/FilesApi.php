...
class FilesApi
{
     ...
     */
    protected function deleteFileRequest($tableId, $recordId, $fieldId, $versionNumber, $qBRealmHostname, $authorization, $userAgent = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function downloadFileRequest($tableId, $recordId, $fieldId, $versionNumber, $qBRealmHostname, $authorization, $userAgent = null)
    {
        // verify the required parameter 'tableId' is set
        if ($tableId === null || (is_array($tableId) && count($tableId) === 0)) {
            throw new \InvalidArgumentException(
